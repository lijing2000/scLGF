...
setwd("D:/Program Files/RStudio/R")
category <- "balanced_data"
ifelse (!dir.exists(paste0("simulated_data/", category)),
        dir.create(paste0("simulated_data/", category)), FALSE)
simulate <- function(nGroups=20, nGenes=2500, dropout=2) # change dropout to simulate various dropout rates
{
  batchCells = 500 * nGroups
...
simulate(nGroups=200, nGenes=2500)
